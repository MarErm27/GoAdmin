...
See [manual](https://github.com/MarErm27/GoAdmin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/MarErm27/GoAdmin clone, so:

```bash

$ go get github.com/MarErm27/GoAdmin
$ cd $GOPATH/src/github.com/MarErm27/GoAdmin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/MarErm27/GoAdmin: no Go files in /go/src/github.com/MarErm27/GoAdmin` is normal.
...
* [Tasks](https://github.com/MarErm27/GoAdmin/projects)
