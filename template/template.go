...
import (
	...
	errors2 "github.com/MarErm27/GoAdmin/modules/errors"
	...
	"github.com/MarErm27/GoAdmin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/MarErm27/GoAdmin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/MarErm27/GoAdmin/blob/master/template/login/list.go
	GetAssetList() []string
