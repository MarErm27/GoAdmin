...
在这里：[功能规划](https://github.com/MarErm27/GoAdmin/projects/3) 可以获得更多信息。
...
然后，你需要fork远程的master分支到你本地 **\$GOPATH**/src/github.com/MarErm27/GoAdmin ：
...
注意了： `go get` 返回 `package github.com/MarErm27/GoAdmin: no Go files in /go/src/github.com/MarErm27/GoAdmin` 是正常的。
